    ...
    'Loop through all sheets
     ...
     ws.Activate
            ...
            If Cells(I + 1, 1).Value <> Cells(I, 1).Value Then
                ...
                'Calculate Yearly_Change
                 ...
                 ElseIf (Open_Price = 0 And Close_Price <> 0) Then
                    Percent_Change = 100 'If open price is 0 but close price is not, then the percent change is undefined or inifinite
                 Else
        ...
        For k = 2 To Yearlastrow
            ...
            If (Cells(k, "K").Value = WorksheetFunction.Max(Range("K2:K" & Yearlastrow))) Then
                'Print the Ticker
            ...
            ElseIf (Cells(k, "K").Value = WorksheetFunction.Min(Range("K2:K" & Yearlastrow))) Then
                'Print the Ticker
            ...
            ElseIf (Cells(k, "L").Value = WorksheetFunction.Max(Range("L2:L" & Yearlastrow))) Then
                'Print the Ticker
